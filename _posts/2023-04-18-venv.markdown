...
Alles zuvor Beschriebene zusammengenommen ermöglicht es, `venv` in einer Build-Umgebung zu verwenden. Wenn etwa ein klassisches Makefile zum Einsatz kommt, kann man, bevor der Python-Interpreter aufgerufen wird, erst einmal eine virtuelle Umgebung aufsetzen.
